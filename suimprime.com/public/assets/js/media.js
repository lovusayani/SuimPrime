...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function loadPaginatedImages() {
        ...
        fetch(`${baseUrl}/admin/media-library/getMediaStore?page=${page}&perPage=${perPage}`)
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function loadImages(query = '') {
        ...
        fetch(`${baseUrl}/admin/media-library/getMediaStore?page=${page}&query=${encodeURIComponent(query)}`)
            .then(response => {
