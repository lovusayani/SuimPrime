...
@section('content')
    ...
    <form class="requires-validation" method="POST" action="{{ route('admin.actors.store') }}" enctype="multipart/form-data"
                ...
                <div class="row gy-3">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" id="name" class="form-control"
                                placeholder="e.g. Henry Williams" required>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="bio" id="bio" class="form-control" rows="6"
                            placeholder="e.g. Henry Williams is an American actor known for..." required></textarea>
                    ...
                    try {
                        ...
                        if (response.ok && result.success) {
                            ...
                            Swal.fire({
                                icon: 'success',
                                title: 'Saved!',
                                text: result.message || 'Actor has been added successfully!',
                                timer: 2000,
