                ...
                <div class="card-body">
                    <div>
                        <div class="d-flex align-items-center justify-content-between">
                            <h4 class="mb-0"><i class="ph ph-currency-circle-dollar fa-lg mr-2"></i>&nbsp;Currency Settings
                            </h4>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2 align-items-center justify-content-end">
                                                    @if (!$currency->is_primary)
                                                        <button type="button" class="btn btn-warning-subtle btn-sm fs-4"
                                                            data-bs-toggle="modal" data-bs-target="#currencyModal"
                                                            onclick="openModal({{ $currency->id }}, '{{ route('admin.settings.currency.edit', $currency->id) }}')">
                                                    ...
                                                    @if (!$currency->is_primary)
                                                        <form
                                                            action="{{ route('admin.settings.currency.destroy', $currency->id) }}"
                                                            method="POST" class="d-inline m-0 delete-form">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
                                                                class="btn btn-secondary-subtle btn-sm fs-4 delete-button"
                        ...
                        <div class="modal-dialog modal-fullscreen-md-down">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="currencyForm" action="{{ route('admin.settings.currency.store') }}"
                                        method="POST">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            <label for="currencySymbol" class="form-label">Currency Symbol <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="currency_symbol" placeholder="Currency Symbol"
                                                id="currencySymbol" class="form-control" value="" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="currencyCode" class="form-label">Currency Code <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="currency_code" placeholder="Currency Code"
                                                id="currencyCode" class="form-control" value="" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="thousandSeparator" class="form-label">Thousand Separator <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="thousand_separator"
                                                placeholder="Thousand Separator" id="thousandSeparator"
                                                class="form-control" value="," required>
                                        </div>
                                        <div class="form-group">
                                            <label for="decimalSeparator" class="form-label">Decimal Separator <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="decimal_separator"
                                                placeholder="Decimal Separator" id="decimalSeparator"
                                                class="form-control" value="." required>
                                        </div>
                                        <div class="form-group">
                                            <label for="noOfDecimal" class="form-label">Number of Decimals <span
                                                    class="text-danger">*</span></label>
                                            <input type="number" name="no_of_decimal" placeholder="Number of Decimals"
                                                id="noOfDecimal" class="form-control" value="2" required>
                                        </div>
                                    </form>
                                </div>
                ...
                if (id === 0) {
                    ...
                    if (editUrl) {
                        ...
                        $.get(editUrl, function(data) {
                            ...
                            $('#currencyForm').attr('action', '{{ route('admin.settings.currency.store') }}'.replace(
                                '/store', '/' + id));
                            $('#formMethod').val('PUT');
                        });
                    }
