            ...
            <div class="card card-accent-primary offcanvas-body mb-0">
                <div class="card-body">
                    <div class="col-md-12 mb-3 d-flex justify-content-between">
                        <h5><i class="ph ph-database"></i> Storage Settings</h5>
                    </div>
                    ...
                    <form method="POST" action="{{ route('admin.settings.storage.update') }}" id="settings-form">
                        ...
                        <div class="form-group border-bottom pb-3">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="form-check form-switch m-0">
                                    <input class="form-check-input storage-checkbox" value="1" name="local"
                                        id="local" type="checkbox"
                                        {{ old('local', \App\Models\Setting::get('local', '1')) == '1' ? 'checked' : '' }}>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group border-bottom pb-3">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="form-check form-switch m-0">
                                    <input class="form-check-input storage-checkbox" value="1" name="s3"
                                        id="s3" type="checkbox"
                                        {{ old('s3', \App\Models\Setting::get('s3', '0')) == '1' ? 'checked' : '' }}>
                                </div>
                            </div>
                        </div>

                        <div id="aws-s3-fields"
                            style="display: {{ old('s3', \App\Models\Setting::get('s3', '0')) == '1' ? 'block' : 'none' }};">
                            <div class="form-group">
                                ...
                                <input type="text" name="aws_access_key" id="aws_access_key" class="form-control"
                                    value="{{ old('aws_access_key', \App\Models\Setting::get('aws_access_key', '')) }}">
                                <div class="invalid-feedback" id="aws_access_key_error" style="display: none;">AWS Access
                                    Key is required.</div>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" name="aws_secret_key" id="aws_secret_key" class="form-control"
                                    value="{{ old('aws_secret_key', \App\Models\Setting::get('aws_secret_key', '')) }}">
                                <div class="invalid-feedback" id="aws_secret_key_error" style="display: none;">AWS Secret
                                    Key is required.</div>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" name="aws_region" id="aws_region" class="form-control"
                                    value="{{ old('aws_region', \App\Models\Setting::get('aws_region', '')) }}">
                                <div class="invalid-feedback" id="aws_region_error" style="display: none;">AWS Region is
                                    required.</div>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" name="aws_bucket" id="aws_bucket" class="form-control"
                                    value="{{ old('aws_bucket', \App\Models\Setting::get('aws_bucket', '')) }}">
                                <div class="invalid-feedback" id="aws_bucket_error" style="display: none;">AWS Bucket is
                                    required.</div>
                            </div>
                            <div class="form-group">
                                <label for="aws_path_style">AWS Use Path Style Endpoint <span
                                        class="text-danger">*</span></label>
                                <select name="aws_path_style" id="aws_path_style" class="form-control">
                                    <option value="false"
                                        {{ old('aws_path_style', \App\Models\Setting::get('aws_path_style', 'false')) == 'false' ? 'selected' : '' }}>
                                        False</option>
                                    <option value="true"
                                        {{ old('aws_path_style', \App\Models\Setting::get('aws_path_style', 'false')) == 'true' ? 'selected' : '' }}>
                                        True</option>
                                </select>
                                <div class="invalid-feedback" id="aws_path_style_error" style="display: none;">AWS Endpoint
                                    is required.</div>
                            </div>
                        </div>
