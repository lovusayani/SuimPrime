        ...
        <div class="row gy-3">
                ...
                <div class="position-relative">
                    ...
                    <div class="input-group btn-file-upload">
                        <button class="input-group-text form-control" type="button" data-bs-toggle="modal"
                            ...
                            data-hidden-input="poster_tv_url" style="height:13.6rem"><i class="ph ph-image"></i>Choose
                            Media to Upload</button>
            ...
            <div class="col-md-4 col-lg-4 mb-3">
                ...
                <input class="form-control" type="text" name="name" id="name" value
                    placeholder="e.g. Avengers: Endgame" required="required">
            ...
            <div class="col-md-4 col-lg-4 mb-3">
                ...
                <div id="url_input">
                    ...
                    <input class="form-control" type="text" name="trailer_url" id="trailer_url" value
            ...
            <div class="col-lg-12">
                ...
                <textarea class="form-control" name="description" id="description"
                    ...
                    rows="5"></textarea> <!-- required="required"  -->
                    ...
                    <label class="form-check form-check-inline form-control px-5 cursor-pointer">
                        <div>
                            <input class="form-check-input" type="radio" name="movie_access" id="paid"
                                ...
                                checked data-cf-modified-8ff08e1f75c3db71988bed4b-="">
    ...
    <div class="card-body">
        <div class="row gy-3">
            ...
            <div class="col-md-6 col-lg-4">
                ...
                <input class="form-control min-datetimepicker-time" type="time" name="duration" id="duration"
            ...
            <div class="col-md-6 col-lg-4" id="dowaloadstatuswapper">
                ...
                <div class="d-flex justify-content-between align-items-center form-control">
                    ...
                    <div class="form-check form-switch">
                        ...
                        <input class="form-check-input" type="checkbox" name="download_status" value="1"
                            checked>
                    </div>
                </div>
            </div>
