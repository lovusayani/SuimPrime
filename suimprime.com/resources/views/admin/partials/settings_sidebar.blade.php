            ...
            <div class="list-group list-group-flush" id="setting-list">
                ...
                <div class="mb-3 active-menu">
                    <a id="link-custom-code" href="{{ route('admin.settings.logo', ['section' => 'custom-code']) }}" class="btn btn-border {{ $section === 'custom-code' ? 'active' : '' }}">
                        <i class="icon ph ph-code me-2"></i> Custom Code
                    </a>
                </div>
                <div class="mb-3 active-menu">
                ...
                <div class="mb-3 active-menu">
                    <a id="link-language-settings" href="{{ route('admin.settings.languageSettings') }}" class="btn btn-border {{ request()->routeIs('admin.settings.languageSettings') ? 'active' : ($section === 'language-settings' ? 'active' : '') }}">
                        <i class="icon ph ph-translate me-2"></i> Language Settings
                    </a>
                </div>
                <div class="mb-3 active-menu">
                    <a id="link-notification-configuration" href="{{ route('admin.settings.notificationConfiguration') }}" class="btn btn-border {{ request()->routeIs('admin.settings.notificationConfiguration') ? 'active' : ($section === 'notification-configuration' ? 'active' : '') }}">
                        <i class="icon ph ph-bell me-2"></i> Notification Configuration
                    </a>
                </div>
                <div class="mb-3 active-menu">
                    <a id="link-currency-settings" href="{{ route('admin.settings.currencySettings') }}" class="btn btn-border {{ request()->routeIs('admin.settings.currencySettings') ? 'active' : ($section === 'currency-settings' ? 'active' : '') }}">
                        <i class="icon ph ph-currency-circle-dollar me-2"></i> Currency Settings
                    </a>
                </div>
                <div class="mb-3 active-menu">
                    <a id="link-storage-settings" href="{{ route('admin.settings.storageSettings') }}" class="btn btn-border {{ request()->routeIs('admin.settings.storageSettings') ? 'active' : ($section === 'storage-settings' ? 'active' : '') }}">
                        <i class="icon ph ph-database me-2"></i> Storage Settings
                    </a>
                </div>
                <div class="mb-3 active-menu">
                    <a id="link-seo-settings" href="{{ route('admin.settings.seoSettings') }}" class="btn btn-border {{ request()->routeIs('admin.settings.seoSettings') ? 'active' : '' }}">
